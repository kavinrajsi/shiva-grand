...
const SUMMARY = [
  ...
  { label: "Check-Out", value: "Oct 26, 2024" },
...
const STEPS = [
  {
    n: "01",
    title: "Verification",
    body: "Our reservation desk verifies room availability for your selected dates.",
  },
  {
    n: "02",
  ...
  },
  {
    ...
    body: "Once confirmed via phone, a formal booking voucher will be sent to your email.",
  },
];
          ...
          <div className="lg:col-span-5 lg:-ml-24 z-10">
            <div className="bg-surface-container-lowest p-10 lg:p-16 shadow-lg rounded-xl">
              ...
              <p className="text-lg text-on-surface-variant leading-relaxed mb-8">
                Thank you for choosing Shiva Grand Residency. Your reservation
                is currently being processed and is{" "}
              ...
              <div className="flex items-center gap-4 bg-secondary-container/30 p-4 rounded-xl border border-primary/5">
                ...
                <p className="text-sm font-medium text-on-secondary-container">
                  Our staff will call you shortly on your provided number to
                  finalize your stay.
                </p>
              </div>
            </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-surface-container-low p-8 rounded-xl flex flex-col justify-between">
            ...
            <p className="text-sm text-on-surface-variant mt-4">
              Please quote this number if you need to contact us before our
              call.
            </p>
          </div>
          ...
          <div className="bg-primary p-12 rounded-xl text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-white/80 mb-8 leading-relaxed">
                If you haven't heard from us or need to change your request
